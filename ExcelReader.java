    ...
    public List check_status(String path) throws FileNotFoundException, IOException{
        ...
        while (rowIterator.hasNext()) {
            ...
            while (cellIterator.hasNext()) {
                ...
                if(cell.getStringCellValue().startsWith("fe")==true || cell.getStringCellValue().startsWith("FE")==true){
                    status_check= cell.getColumnIndex();
                    ;
                }
                else if (cell.getStringCellValue().startsWith("bo")==true || cell.getStringCellValue().startsWith("BO")==true){
